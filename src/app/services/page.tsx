...
export default function ServicesPage() {
  ...
  return (
    <main className="min-h-screen bg-surface">
      ...
      {/* Page Hero Section - Optimized for Mobile */}
      ...
      <Section background="surface" id="services-grid" containerClassName="py-12 md:py-20">
        ...
        {/* Mobile Grid Layout: 12 services in 2 columns */}
        ...
        <section className="w-full bg-blue-950 py-24 md:py-36 px-8 text-white relative overflow-hidden">
          ...
          >
            ...
            <motion.div 
              ...
              className="flex flex-col sm:flex-row justify-center items-center gap-6 md:gap-8 pt-4 md:pt-8"
            >
...
const ServiceCardWrapper = ({ service, activeCardId, handleCardClick, handleBook }: { service: any, activeCardId: string | null, handleCardClick: (id: string) => void, handleBook: (e: React.MouseEvent) => void }) => (
  <motion.div 
    variants={{
