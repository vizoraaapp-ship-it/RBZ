            ...
            >
              <div className="absolute inset-0 bg-primary/5 backdrop-blur-sm flex items-center justify-center">
                ...
                <motion.div 
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-8 py-4 rounded-2xl shadow-2xl font-black text-primary tracking-tight cursor-pointer"
                >
                  View On Google Maps
                </motion.div>
              </div>
